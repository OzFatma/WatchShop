...
namespace UnitTests.ApplicationCore.Services.BasketServices
{
    public class DeleteBasket
    {
        ...
        {
            _mockBasketRepository.Setup(x => x.FirstOrDefaultAsync(It.IsAny<BasketWithItemsSpecification>())).ReturnsAsync(new Basket() { Id = _existingBasketId });
